...
public class Chart {
	...
	void setColors()
	{
		...
		graphColor[0]=new GraphColor(200,0,0); // Channel 1 Accel X
		graphColor[1]=new GraphColor(150,0,0); // Channel 2 Accel X
		graphColor[2]=new GraphColor(0,100,0); // Channel 1 Accel Y
		graphColor[3]=new GraphColor(0,50,0); // Channel 2 Accel Y
		graphColor[4]=new GraphColor(0,0,250); // Channel 1 Accel Z
		graphColor[5]=new GraphColor(0,0,200); // Channel 2 Accel Z
		graphColor[6]=new GraphColor(200,0,0); // Channel 1 Gyro X
		graphColor[7]=new GraphColor(150,0,0); // Channel 2 Gyro X
		graphColor[8]=new GraphColor(0,100,0); // Channel 1 Gyro Y
		graphColor[9]=new GraphColor(0,50,0); // Channel 2 Gyro Y
		graphColor[10]=new GraphColor(0,0,250); // Channel 1 Gyro Z
		graphColor[11]=new GraphColor(0,0,200); // Channel 2 Gyro Z
    ...
    public Chart(Context context, int iScreenBuffCount, SamplesBuffer[] samplesBuffer,
		...
		graphColor = new GraphColor[12]; // We have 12 colors
